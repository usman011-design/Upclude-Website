...
interface CarouselSlideProps {
  ...
  isActive: boolean // 👈 pass this when switching slides
}
...
export function CarouselSlide({
  ...
  return (
    <AnimatePresence>
      {isActive && (
        <motion.div
          key={title} // unique key for each slide
          ...
          className={`relative h-screen w-full ${bgGradient}`}
          style={{ transformStyle: "preserve-3d", perspective: 1200 }} // 👈 enables 3D flip
        >
              ...
              <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-2 lg:gap-8">
                <div className="z-10 ml-12 max-w-lg text-white md:ml-16 lg:ml-22 mt-4">
                  ...
                  <div className="flex flex-wrap gap-4 md:gap-4">
                    <a href={appStoreLink} className="flex items-center gap-2 rounded-full bg-black px-6 py-1 text-white transition-transform hover:scale-105 md:px-6 md:py-2">
                      <Image src="../../Social Icons.svg" alt="apple icon" height={20} width={20} />
                      <div className="text-left">
                        <div className="text-sm md:text-[10px]">Download app</div>
                        <div className="text-[10px] font-semibold md:text-xs">App Store</div>
                      </div>
                    </a>
                    <a href={playStoreLink} className="flex items-center gap-2 rounded-full bg-white px-6 py-1 text-gray-900 transition-transform hover:scale-105 md:px-6 md:py-2">
                      <Image src="../../image 14.svg" alt="play store icon" height={20} width={20} />
                      <div className="text-left">
                        <div className="text-sm md:text-[10px]">Download app</div>
          ...
          <div className="absolute bottom-4 left-0 right-0 z-10 flex items-center justify-between px-4 text-white md:bottom-6 md:px-8 lg:px-16">
            ...
            <div className="flex gap-2.5 md:gap-3">
              <a href="#" className="transition-opacity hover:opacity-70"><Image src="../../fi_facebook.svg" alt="facebook" height={15} width={15} /></a>
              <a href="#" className="transition-opacity hover:opacity-70"><Image src="../../Vector.svg" alt="twitter" height={15} width={15} /></a>
              <a href="#" className="transition-opacity hover:opacity-70"><Image src="../../Vector (1).svg" alt="youtube" height={15} width={15} /></a>
              <a href="#" className="transition-opacity hover:opacity-70"><Image src="../../Vector (2).svg" alt="other" height={12} width={12} /></a>
            </div>
          </div>
        </motion.div>
      )}
